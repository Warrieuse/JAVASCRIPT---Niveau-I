...
//Premier boss
//si votre personnage possède une épée ou un bouclier, il arrive à vaincre ce boss
console.log("Premier boss : le dragon d' OR")
if (epee=true) { //Ecrivez entre les parenthèses les tests correspondants
...
if (bouclier=true) { //Ecrivez entre les parenthèses les tests correspondants
...
if ((casque=true) && (epee=true) && (bouclier=true)) { //Ecrivez entre les parenthèses les tests correspondants
